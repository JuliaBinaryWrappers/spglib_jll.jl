# Autogenerated wrapper script for spglib_jll for x86_64-apple-darwin14
export libsymspg
...
const libsymspg_splitpath = ["lib", "libsymspg.1.15.1.dylib"]
...
const libsymspg = "@rpath/libsymspg.1.dylib"

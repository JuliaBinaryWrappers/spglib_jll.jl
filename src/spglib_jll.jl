...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import spglib_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ac4a9f1e-bdb2-5204-990c-47c8b2f70d4e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "spglib", artifacts_toml) for e in artifacts["spglib"]]
...
if best_platform === nothing
    @debug("Unable to load spglib; unsupported platform $(triplet(platform_key_abi()))")
else
